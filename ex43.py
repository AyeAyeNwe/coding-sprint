...
class LaserWeaponArmory(Scene):
    def enter(self):
        ...
        if guess == code:
            print(dedent("""
                The container clicks open and the seak breaks ,letting
    ...
    def enter(self):
        ...
        if action == "throw the bomb":
            print(dedent("""
                ...
                Gothon shoots you right inthe back killing you.As
            ...
            print(dedent("""
                ...
                Gothons can't get out.Now that the boomb is placed
    ...
    def enter(self):
        ...
        if int(guess) != good_pod:
            ...
            print(dedent("""
                ...
                back and see your ship implode then explode like a bright star 
                taking out the Gothon ship at the same
                time.You won!
                """))
            return 'finished'
